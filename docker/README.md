This folder contains Dockerfiles for Ubuntu 18.04 ROS Melodic and Ubuntu 20.04 ROS Noetic images. Also, one-liner is provided to pull a specified docker image and run the respective container.
...
Built from `ros:melodic-perception`. Adds a user, amongst other things, to speed up CI builds. Forms the basis for most ROS Melodic images. [Dockerfile](ros/melodic/base/Dockerfile).

#### build-tools:noetic

Built from `ros:kinetic-perception`. Adds a user, amongst other things, to speed up CI builds. Forms the basis for most ROS Noetic images. [Dockerfile](ros/noetic/base/Dockerfile)
