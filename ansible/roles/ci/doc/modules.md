...
## List of modules
  ...
  * **code_style_check** - run [roslint](http://wiki.ros.org/roslint) to check C++ and Python code in all packages of the project. Also, check if copyright notice is present in all the files and the license file exsists in the repository. 
